...
- `tests/e2e/` - acceptance tests for US-001..US-007 (E2E-001..085, 086..102)
...
`make check` must pass before each commit: ruff lint, ruff format-check, mypy strict, pytest (100/100 acceptance tests).
